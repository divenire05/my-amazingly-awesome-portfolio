...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Vedant</span> Badoni <br/> Full Stack <span class="poppins text-violet-400">Developer</span>
            </h2>
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" class="mx-auto px-4 py-2 rounded-md border border-solid border-white flex items-center gap-2 hover:border-violet-700 duration-200 -mb-4 sm:-mb-0 -mt-10">
            <i class="fa-regular fa-circle-play"></i>
            <p>Watch the video</p>
        </a>
        <div class="grid grid-cols1 lg:grid-cols-3 gap:12 lg:gap-10">
            <Step step={steps[0]}>
                <p>Vedant Badoni Store is a merchandising store created with <strong class="text-violet-400">Next.js, Commerce.js, Stripe, & Node.js + Express.js!</strong> Commerce.js is a product CMS and Stripe is used for all transaction handling.</p>
            </Step>
            <Step step={steps[1]}>
                <p>Ultimate Todos is a Full Stack <strong class="text-violet-400">Next.js, Node.js + Express.js, & Firebase</strong> CRUD application that allows a user to login, manage a tidy and efficacious todo list, and persist this information across all devices.</p>
            </Step>
            <Step step={steps[2]}>
    ...
    <section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        <div class="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-violet-700 after:absolute after:bottom-0 after:w-2/3 after:right-0 after:h-1.5 after:bg-violet-700 py-4">
